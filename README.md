...
> 2023/6/29 更新
>
> 鉴于各位朋友们的喜欢，把这个项目的代码修改完善了一下，现在跑起来各功能基本上没有很大的问题（注意：会员登录是通过手机号登录）。
>
...
> 注意：本项目sql文件没保存，后来重装系统丢失了，需要的朋友，可以根据实验报告里数据库设计以及Java的实体类代码复现。(已经提供了我复现的sql)
>
> 需代做课设，毕设可联系我QQ:2455675487
