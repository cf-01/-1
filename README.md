...
>
> 但是由于当时初学springboot和vue，对很多东西没理解，所以代码写的有点蠢，目前也没有太多时间去修改重构，各位谨慎使用。
>
> 另外，如果对您有帮助，请帮我点个小星星，这将对我帮助很大，感谢！


> 注意：本项目sql文件没保存，后来重装系统丢失了，需要的朋友，可以根据实验报告里数据库设计以及Java的实体类代码复现。(已经提供了我复现的sql,在doc目录下)
>
> 如果你是mysql5，你可以使用 gym_mysql5.sql 导入。
> 
> **会员登录部分是通过手机号登录的，很多朋友这里遇到了问题**
> 
> 需代做课设，毕设可联系我QQ:2455675487。如需远程帮忙部署项目，也可以联系我，66元帮您远程部署好。
